...
import {E} from '../../source/puzzle/exports';

const assert = require('chai').assert;

describe.skip('Project Euler', function() {
  ...
  it('solves euler005', function() {
    assert.equal(E.euler005(), 232792560);
  });

  it('solves euler006', function() {
  ...
  it('solves euler013', function() {
    assert.equal(E.euler013(), '5537376230');
  });

  it('solves euler014', function() {
    assert.equal(E.euler014(), 837799);
  });

  it('solves euler015', function() {
  ...
  it('solves euler018', function() {
    assert.equal(E.euler018(), 1074);
  });

  it('solves euler019', function() {
    assert.equal(E.euler019(), 171);
  });

  it('solves euler020', function() {
    assert.equal(E.euler020(), 648);
  });

  it('solves euler021', function() {
    assert.equal(E.euler021(), 31626);
  });

  it('solves euler022', function() {
    assert.equal(E.euler022(), 871198282);
  });

  it('solves euler023', function() {
  ...
  it('solves euler026', function() {
    assert.equal(E.euler026(), 983);
  });

  it('solves euler027', function() {
    assert.equal(E.euler027(), -59231);
  });

  it('solves euler028', function() {
    assert.equal(E.euler028(), 669171001);
  });

  it('solves euler029', function() {
  ...
  it('solves euler031', function() {
    assert.equal(E.euler031(), 73682);
  });

  it('solves euler032', function() {
    assert.equal(E.euler032(), 45228);
  });

  it('solves euler033', function() {
