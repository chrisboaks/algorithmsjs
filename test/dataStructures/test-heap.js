...
import {Heap} from '../../source/dataStructures/heap';

describe('Heap', function() {
  describe('#constructor', function() {
    it('stores an empty array if no args are passed', function() {
      const h = new Heap();
      assert.sameMembers(h._items, []);
    });

    it('stores any passed args into the heap', function() {
  ...
  describe('Heap.parent', function() {
    it('finds the parent index of a given index', function() {
  ...
  describe('Heap.left', function() {
    it('finds the left child index of a given index', function() {
  ...
  describe('Heap.right', function() {
    it('finds the right child index of a given index', function() {
  ...
  describe('#extractMin', function() {
    it('extracts and returns the smallest element', function() {
  ...
  describe('#sort', function() {
    it('returns an array of the sorted items', function() {
    ...
    it('is non-destructive to the original heap', function() {
      const h = new Heap(2, 4, 6, 8, 10);
      h.sorted();
